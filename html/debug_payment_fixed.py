#!/usr/bin/env python3
"""
Debug script to test payment creation with fixed logic
"""
...
def debug_payment_fixed():
    """Test payment creation with fixed logic"""
    print("🔍 Testing payment creation with fixed logic...")
    ...
    payment_data = {
        ...
        "description": "DEBUG_PAYMENT_FIXED_LOGIC_001"
    }
    
    print(f"🧪 Creating payment with fixed logic...")
