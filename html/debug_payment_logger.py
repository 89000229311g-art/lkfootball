#!/usr/bin/env python3
"""
Debug script to test payment creation with logger debug output
"""
...
def debug_payment_with_logger():
    """Test payment creation with logger debug output"""
    print("🔍 Testing payment creation with logger debug output...")
    ...
    payment_data = {
        ...
        "description": "DEBUG_PAYMENT_WITH_LOGGER_777"
    }
    
    print(f"🧪 Creating payment with logger debug...")
