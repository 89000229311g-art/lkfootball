#!/usr/bin/env python3
"""
Updated test script for payment notifications with correct payment_period format
"""
...
def test_receipt_upload_notification():
    ...
    # Get student
    students_response = requests.get(f"{API_BASE}/students?search=Миша", headers=parent_headers)
