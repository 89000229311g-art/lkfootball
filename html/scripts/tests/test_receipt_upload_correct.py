#!/usr/bin/env python3
"""
Test receipt upload with correct endpoint
"""
...
def test_receipt_upload_with_correct_endpoint():
    """Test receipt upload with correct endpoint"""
    print("🧪 Testing receipt upload with correct endpoint...")
...
if __name__ == "__main__":
    test_receipt_upload_with_correct_endpoint()