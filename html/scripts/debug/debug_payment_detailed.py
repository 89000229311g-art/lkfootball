#!/usr/bin/env python3
"""
Debug script to test payment creation with detailed server-side logging
"""
...
def debug_payment_detailed():
    """Test payment creation with detailed logging"""
    print("🔍 Testing payment creation with detailed logging...")
    ...
    payment_data = {
        ...
        "description": "DEBUG_PAYMENT_WITH_LOGGING_456"
    }
    ...
    for i, notification in enumerate(notifications):
        ...
        if 'DEBUG_PAYMENT_WITH_LOGGING_456' in content or 'оплата' in content.lower():
