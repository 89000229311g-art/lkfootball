#!/usr/bin/env python3
"""
Debug script to test payment creation with server-side logging
"""
...
def debug_payment_with_server_logging():
    """Test payment creation with server-side logging"""
    print("🔍 Testing payment creation with server logging...")
    ...
    # Create payment with a specific description to identify it in logs
    payment_data = {
        ...
        "description": "DEBUG_PAYMENT_NOTIFICATION_123"
    }
    ...
    for i, notification in enumerate(notifications):
        ...
        if 'DEBUG_PAYMENT_NOTIFICATION_123' in content or 'оплата' in content.lower():
...
if __name__ == "__main__":
    debug_payment_with_server_logging()